...
def grabvial():
    AK.setPitchRangeMoving((0, 18, 5), -90,-90, 0, 500)
    time.sleep(2)
    Board.setBusServoPulse(1, 600, 1500) #Close gripper
    time.sleep(3)
    AK.setPitchRangeMoving((0, 18, 10), -90,-90, 0, 500)
    time.sleep(2)
    AK.setPitchRangeMoving((20, 0, 10), -90,-90, 0, 1500) 
    time.sleep(2)
    Board.setBusServoPulse(2, 500, 500) 
    AK.setPitchRangeMoving((20, 0, 6), -90,-90, 0, 1000) 
    time.sleep(2)
   

def returnvial():
    AK.setPitchRangeMoving((20, 0, 10), -90,-90, 0, 1000) 
    time.sleep(2)
    AK.setPitchRangeMoving((0, 18, 10), -90,-90, 0, 500)
    time.sleep(2)
    AK.setPitchRangeMoving((0, 18, 6), -90,-90, 0, 500)
    time.sleep(2)
    Board.setBusServoPulse(1, 400, 1500) #Open gripper
    time.sleep(3)
    initMove()
    ...
    while True:
        if tag_id is not None:
            ...
            if x_st and y_st:  #机械臂已经在物块的上方
                ...
                time.sleep(1)
                # 机械臂进行夹取
                AK.setPitchRangeMoving((x, y+1.6, 2), -90,-90, 0, 500)
                time.sleep(2)
                Board.setBusServoPulse(1, 400, 1500) #Close gripper
                time.sleep(3)
                Board.setBusServoPulse(1, 400, 1500) #Open gripper
                time.sleep(3)
                AK.setPitchRangeMoving((x, 8, 5), -90,-90, 0, 500) #Move Down
                time.sleep(2)
                Board.setBusServoPulse(1, 400, 1500) #Close gripper
                time.sleep(3)
                # 夹取后，抬起
